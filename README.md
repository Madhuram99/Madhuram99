...
# Hey there, I'm Madhuram Rathi 👋

### *I don't just call APIs — I design systems.*

**Founding AI Engineer @ Stealth** • **B.Tech CS @ PEC** • **JEE Advanced AIR 4894**
...
### 🤖 [ProspectIQ](https://github.com/Madhuram99/ProspectIQ)
**AI-Powered SDR Agent System**

A comprehensive sales automation platform with **multi-agent architecture** for end-to-end lead generation and outreach.

`Python` `FastAPI` `Gemini 2.0` `ElevenLabs` `Docker`
...
### 🔍 [Issue Detection Service](https://github.com/Madhuram99/issue-detection-service)
**Agentic Duplicate Detection**

An AI system that classifies requirements and detects duplicates across ticketing systems.

`LangGraph` `FAISS` `XGBoost` `MCP` `Linear API`
...
### 🛡️ [Verify.ai](https://github.com/Madhuram99/verify.ai)
**Agentic RAG with Auditability**

Turn raw, untrusted data into **qualified, auditable, explainable knowledge**.

`Python` `RAG` `LLM` `Agentic AI`
...
### 📝 [prompts-layer](https://github.com/Madhuram99/prompts-layer)
**PromptOps Infrastructure**

Treat prompts like code: **versioned, validated, and observable**.

`Flask` `YAML` `Jinja2` `JSON Schema`
...
### 🎭 [Deepfake Detection](https://github.com/Madhuram99/deepfake-RestNext-LSTM)
**Video Authenticity Verification**

Deepfake detection using **transfer learning** with ResNeXt + LSTM.

`PyTorch` `CNN` `LSTM` `Transfer Learning`
...
### 🔗 [Knot](https://github.com/Madhuram99/Knot)
**Resilient File Transfer**

A smart file transfer system that handles failures gracefully.

`TypeScript` `Network Programming`
